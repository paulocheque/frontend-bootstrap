...
gulp.task('copy', function () {
  ...
  var bower = gulp.src([
    'bower_components/**/*', '!**/test*{,/**}', '!**/demo*{,/**}', '!**/demo*.html', '!**/*.json', '!**/*.md', '!**/*.log'
...
gulp.task('fonts', function () {
  return gulp.src(['app/fonts/**', 'bower_components/**/fonts/*'])
...
gulp.task('html', function () {
  var assets = $.useref.assets({searchPath: ['.tmp', 'app', 'dist']}).on('error', gutil.log)
